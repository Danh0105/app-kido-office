...
export default function PolicyStatsPage() {
    ...
    const subjects = useMemo<Subject[]>(() => {
        ...
        filteredPolicies.forEach((item: any) => {
            if (!item.subjectId) return; // 🚨 tránh null/undefined
    ...
    const schoolYears = useMemo(() => {
        ...
        return [...new Set(schoolData.map((i: any) => i.schoolYear))];
    }, [schoolData]);
    ...
    console.log("FILTERED:", filteredPolicies.length);
    ...
    const cards = useMemo(() => {
        return treeData.flatMap((school: any) =>
                ...
                <div className="flex items-center gap-2 mb-4 md:hidden">
                    ...
                    <div className="flex gap-2 flex-1">
                        ...
                        <select
                            ...
                            value={selectedYear || ""}
                            onChange={(e) =>
                                setSelectedYear(e.target.value || undefined)
                            }
                        >
