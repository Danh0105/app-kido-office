...
export default function SidebarRegion({ data, selected, onSelect, onSelectSchool }: any) {
    ...
    useEffect(() => {
        const fetchWards = async () => {
            const res = await wardApi.getByEmployee(Number(getEmployeeId()));
            setWards(res || []);
        };
        fetchWards();
    }, []);
    ...
    return (
        <div className="h-full overflow-y-auto bg-white border-r p-4">
            <h2 className="font-bold mb-4">KV / Tỉnh / Thành</h2>
                        ...
                        >
                            <div>
                                ...
                                <div className="flex gap-2 mt-1">
                                    <p className="text-xs px-2 py-0.5 bg-gray-200 rounded-full text-center">
